    ...
    <section className="w-full py-20 md:py-32 bg-black text-white border-t border-white/10 overflow-hidden">
      <div className="container mx-auto px-4 md:px-6">
        ...
        >
          ...
          <p className="text-lg text-gray-400 font-semibold">Innovation powered by AI. Impact driven by empathy.</p>
        </motion.div>

        <motion.div 
          {...fadeInAnimation}
          className="max-w-4xl mx-auto space-y-4 text-gray-300 mb-20"
        >
          <p>
        ...
        {/* Video */}
        <div className="relative w-full aspect-video mb-20 bg-black">
          <video
            src="/survivalpending.mp4"
        ...
        >
          ...
          <div className="relative mb-8">
            ...
            {/* Solution - Single unified block */}
            <motion.div
              {...fadeInAnimation}
              transition={{ delay: 0.5 }}
              className="group relative bg-gradient-to-br from-green-900/20 to-gray-900 border border-green-500/20 rounded-2xl p-8 hover:border-green-400/40 transition-all duration-500 mt-4"
          ...
          <div className="mt-8">
            <motion.div
              ...
              className="group relative bg-gradient-to-bl from-orange-900/20 via-amber-900/20 to-gray-900 border border-orange-500/20 rounded-2xl p-8 mb-12 hover:border-orange-400/40 transition-all duration-500"
          ...
          >
            <a 
              ...
              className="group relative inline-flex items-center justify-center px-8 py-3 bg-gradient-to-br from-gray-800 to-gray-900 border border-gray-800 text-white font-semibold rounded-xl hover:border-chartreuse/30 transition-all duration-300 hover:scale-105 overflow-hidden"
            >
              <div className="absolute inset-0 bg-gradient-to-br from-chartreuse/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-700 ease-in-out" />
              <span className="relative z-10 flex items-center group-hover:text-chartreuse transition-colors duration-300">
                Visit Live Site
