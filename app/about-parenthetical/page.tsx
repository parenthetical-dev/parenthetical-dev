  ...
  return (
    <main className="bg-black">
      ...
      <section className="relative w-full min-h-screen flex flex-col overflow-hidden">
        {/* Animated Gradient Background - Purple theme for purpose */}
        <div className="absolute inset-0 opacity-20">
          <div className="absolute inset-0 bg-gradient-to-br from-purple-500/15 via-transparent to-purple-600/10 animate-pulse" />
          <div className="absolute inset-0 bg-gradient-to-tl from-purple-600/10 via-transparent to-purple-500/5 animate-pulse" style={{ animationDelay: '1s' }} />
        ...
        <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-purple-600/10 rounded-full blur-3xl animate-[float_20s_ease-in-out_infinite_reverse]" style={{ animationDelay: '10s' }} />
        ...
        <div className="container mx-auto px-4 md:px-6 pt-32 md:pt-40 flex-grow flex flex-col justify-center">
          ...
          >
            <div className="bg-gradient-to-br from-gray-800/20 to-gray-900 border border-gray-700/50 rounded-3xl p-10 md:p-12">
              <div className="flex items-start gap-4 mb-6">
                <BookOpen className="w-8 h-8 text-gray-400 flex-shrink-0 mt-1" />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-12">
              {[
                ...
                <motion.div
                  ...
                  className="flex items-start gap-3 bg-gradient-to-br from-gray-800/20 to-gray-900 border border-gray-700/50 rounded-xl p-4"
                >
          ...
          >
            ...
            <div className="space-y-8">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <motion.div
                  {...fadeInAnimation}
                  className="bg-gradient-to-br from-gray-800/20 to-gray-900 border border-gray-700/50 rounded-2xl p-8"
                >
                  <h3 className="text-xl font-bold text-gray-300 mb-4">From Marketing:</h3>
                ...
                <motion.div
                  ...
                  className="bg-gradient-to-br from-gray-800/20 to-gray-900 border border-gray-700/50 rounded-2xl p-8"
                >
                  <h3 className="text-xl font-bold text-gray-300 mb-4">From Technology:</h3>
                  <p className="text-gray-300">
                ...
                <motion.div
                  ...
                  className="bg-gradient-to-br from-gray-800/20 to-gray-900 border border-gray-700/50 rounded-2xl p-8"
                >
                  <h3 className="text-xl font-bold text-gray-300 mb-4">The Synthesis:</h3>
                  <p className="text-gray-300">
            ...
            <div className="bg-gradient-to-br from-gray-800/20 to-gray-900 border border-gray-700/50 rounded-3xl p-10 md:p-12">
              <div className="flex flex-col md:flex-row gap-8 items-start">
                ...
                <a 
                  ...
                  className="inline-flex items-center gap-2 text-gray-400 hover:text-gray-300 transition-colors mt-4"
                >
            ...
            <div className="mb-16">
              <div className="bg-gray-900/50 backdrop-blur-sm border border-gray-800 rounded-3xl p-8 md:p-12">
                ...
                <motion.div
                  ...
                  className="group relative bg-gradient-to-br from-gray-800/20 to-gray-900 border border-gray-700/50 rounded-3xl p-8 hover:border-gray-600/40 transition-all duration-500"
                >
                  <h4 className="text-2xl font-bold mb-4 text-gray-300">The Brief</h4>
                ...
                <motion.div
                  ...
                  className="group relative bg-gradient-to-br from-gray-800/20 to-gray-900 border border-gray-700/50 rounded-3xl p-8 hover:border-gray-600/40 transition-all duration-500"
                >
                  <h4 className="text-2xl font-bold mb-4 text-gray-300">The Solution</h4>
                  <p className="text-gray-300 leading-relaxed">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8">
                  <a 
                    ...
                    target="_blank" 
                    rel="noopener noreferrer"
                    className="group relative inline-flex items-center justify-center px-8 py-3 bg-purple-500/20 backdrop-blur-md border border-purple-500/50 text-purple-300 font-semibold rounded-xl hover:bg-purple-500/30 hover:border-purple-500/70 transition-all duration-300 hover:scale-105 shadow-xl"
                  >
      ...
      <section className="w-full py-16 md:py-20">
        <div className="container mx-auto px-4 md:px-6">
          ...
          >
            ...
            <div className="bg-gradient-to-br from-gray-800/20 to-gray-900 border border-gray-700/50 rounded-2xl p-8 mb-8">
          ...
          >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <motion.div
                ...
                className="bg-gradient-to-br from-gray-800/20 to-gray-900 border border-gray-700/50 rounded-2xl p-8"
              >
                <h3 className="text-2xl font-bold text-gray-300 mb-6">For Organizations:</h3>
              ...
              <motion.div
                ...
                className="bg-gradient-to-br from-gray-800/20 to-gray-900 border border-gray-700/50 rounded-2xl p-8"
              >
                <h3 className="text-2xl font-bold text-gray-300 mb-6">For Communities:</h3>
                <ul className="space-y-3">
                  {[
      ...
      <section className="w-full pt-8 pb-16 md:pt-10 md:pb-20">
        <div className="container mx-auto px-4 md:px-6">
          ...
          >
            <div className="bg-gradient-to-br from-gray-800/20 to-gray-900 border border-gray-700/50 rounded-3xl p-10 md:p-12">
              <div className="flex items-start gap-4 mb-6">
                <Heart className="w-8 h-8 text-gray-400 flex-shrink-0 mt-1" />
              ...
              <ul className="space-y-3">
                {[
                  ...
                  <li key={index} className="flex items-start gap-3 text-gray-300">
                    <Rocket className="w-5 h-5 text-gray-400 flex-shrink-0 mt-1" />
                    <span>{item}</span>
                  </li>
                ))}
              </ul>
